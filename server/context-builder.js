...
export function buildContext({ leadState, session, messages, retrievedKnowledge, nextMissingField }) {
  ...
  return {
    ...
    lead_state: {
      ...
      troca_modelo: leadState.troca_modelo,
      troca_ano: leadState.troca_ano,
      troca_km: leadState.troca_km,
      troca_quitado: leadState.troca_quitado,
      ...
      veiculo_contexto: leadState.veiculo_contexto,
